...
## Frontend
- [x] T08 `build.mjs`: cartão "Sua leitura" substitui o "Retomar"; expõe a lista de capítulos ao JS
- [x] T09 `tema/app.js`: progresso local + remoto; barra e contagem
- [x] T10 `build.mjs` + `app.js`: bloco de fim de capítulo (1º em diante, dispensável)
- [x] T11 `tema/companion.js` + `entrar.js`: consentimento de contato + revogação
- [x] T12 CSS
